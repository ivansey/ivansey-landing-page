    ...
    render() {
        return <div className="page">
            ...
            <div className="row">
                ...
                <Review title="Андрей Тарасевич"
                        desc=""
                        tags="Несмотря на молодой возраст исполнитель удивил профессионализмом, ответственностью, и желанием делать свою работу хорошо. Желаю ему всяческих профессиональных и творческих успехов, и рекомендую к сотрудничеству!"/>
            </div>
        </div>
    }
}
